  ...
  return (
    ...
    <div className="h-full w-full pb-3">
      ...
      <div className="w-full h-full mt-5 relative overflow-y-auto items-center justify-center">
          ...
          <div className="text-main-color-1 font-bold text-2xl pl-1 mb-5">History</div>
        
        <table className="w-full">
          <thead className="sticky top-0 bg-gray-scale-4 py-10">
            <tr>
              {reportTableHeaders.map((header, idx) => (
                <th key={idx} className="border-b-4 border-slate-600 pr-1">
                  {header}
                </th>
              ))}
            </tr>
          ...
          <tbody>
            {reports.map((data, idx) => (
              ...
              >
                  <td
                    className="border-b-2 border-slate-700 text-center h-14 pr-1"
                    data-value={data._id}
                  >
                  ...
                  <td
                    className="border-b-2 border-slate-700 text-center px-1 pl-1 pr-5"
                    data-value={data._id}
                  >
