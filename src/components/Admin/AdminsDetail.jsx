  ...
  return (
    <div>
      ...
      <div className="flex flex-row justify-center">
        <button className="flex justify-center items-center w-20 h-6 bg-gray-scale-3 cursor-pointer m-20">
          Update
        </button>
        <button className="flex justify-center items-center w-20 h-6 bg-delete cursor-pointer m-20">
          Delete
        </button>
      </div>
    </div>
